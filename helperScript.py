...
def generate_merged_image(input_path):
    facehair_path = os.path.join(input_path,'facehair.png')
    garment_top_path = os.path.join(input_path , 'garment_top.png')
    positions_path = os.path.join(input_path , 'positions.json')
...
generate_merged_image(os.path.join("outputpairs","1"))
